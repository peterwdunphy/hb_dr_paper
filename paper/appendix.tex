...
(social vulnerability and progression). Test 2 is the evidence base for the
companion manuscript on academic ophthalmology proximity. Tests 4, 7 and 8 are
diagnostics that constrain the interpretation of both.
...
Figures 1 to 4 of the companion manuscript on academic ophthalmology display
these results graphically. In the spatial model, academic drive time retains a
