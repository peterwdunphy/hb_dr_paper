...
64 (difference 0.004, $p = 0.18$). The association persisted under a Leroux
...
analyses only. Models include stratum fixed effects, so the social
...
Medicare coverage is near-universal. It was not. Estimated within demographic
strata, the SVI coefficient was 0.037 among adults aged 40 to 64 and 0.033
among adults aged 65 to 84, a difference of 0.004 that did not approach
significance ($z = 1.35$, $p = 0.18$). The same pattern held in each race
stratum separately (Table~\ref{tab:strata}).
