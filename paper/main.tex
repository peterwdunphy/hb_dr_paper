...
strata examined ($\beta$ 0.032 to 0.046). It was only about 12\% smaller among adults aged 65
to 84, who are near-universally Medicare eligible, than among adults aged 40 to
64, though the interaction was statistically detectable and corresponded to
only about a 12\% attenuation ($-0.0036$, $p = 0.002$). The association persisted under a Leroux
...
refitted the primary model using a composite of the remaining three themes. The
...
\multirow{2}{*}{Diagnostic intensity}
 & Base (block sample)                & 0.0353 & 0.0016 & $<0.001$ \\
